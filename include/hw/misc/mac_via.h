...
#define VIA2_SLOT_IRQ_NB        7

#define VIA2_SLOT_IRQ_9         0
#define VIA2_SLOT_IRQ_A         1
#define VIA2_SLOT_IRQ_B         2
#define VIA2_SLOT_IRQ_C         3
#define VIA2_SLOT_IRQ_D         4
#define VIA2_SLOT_IRQ_E         5
#define VIA2_SLOT_IRQ_INTVIDEO  6
